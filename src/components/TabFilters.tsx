...
const TabFilters = (props) => {
  ...
  const [rangePrices, setRangePrices] = useState([0.0, 100]);
  ...
  const handleChangePriceRange = (ranges: number[]) => {
    ...
    console.log("handleChangePriceRange() ranges ===> ", ranges);
        ...
        {({ open, close }) => (
          <>
            ...
            >
              ...
              <span className="ml-2">{`${rangePrices[0]} DCORE - ${rangePrices[1]} DCORE`}</span>
              {renderXClear()}
            </Popover.Button>
            <Transition
              as={Fragment}
              ...
              <Popover.Panel className="absolute z-40 w-screen max-w-sm px-4 mt-3 left-0 sm:px-0 ">
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                  ...
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
                    <ButtonThird
                      onClick={() => {
                        handleChangePriceRange([0.0, 100]);
                        close();
                      }}
                      sizeClass="px-4 py-2 sm:px-5"
                    >
