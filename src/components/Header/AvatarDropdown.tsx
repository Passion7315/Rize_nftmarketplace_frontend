...
import { changeAuthor, changeChainId, changeGlobalProvider, changeWalletAddress, selectCurrentUser } from "app/reducers/auth.reducers";


export default function AvatarDropdown() {
  const { disconnect }: any = useSigningClient();  
